...
if page == 'Head-to-Head':
    ...
    team1_prob = prob_data_filtered[prob_data_filtered["School"].isin([team1])]["xgb_probabilities"]
    team2_prob = prob_data_filtered[prob_data_filtered["School"].isin([team2])]["xgb_probabilities"]
